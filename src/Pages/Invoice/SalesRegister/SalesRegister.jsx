...
const createColumns = (getDetials) => [
    {
      headerName: "",
...
function SalesRegister() {
  ...
  const getDetials = useCallback(async (row) => {
    setOpen(row);
    setLoading(true);
  ...
  const columns = useMemo(() => createColumns(getDetials), [getDetials]);
